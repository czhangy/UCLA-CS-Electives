...
for (let laureate of data) {
    ...
    if (laureate.birth) {
        ...
        city = laureate.founded.place.city
            ? laureate.founded.place.city.en
            : "\\N";
    ...
    if (laureate.orgName) {
        ...
        fs.writeFileSync(
            "./founded.del",
            `${id}\t${placeDict[placeKey]}\t${foundingDate}\n`,
            {
                flag: "a+",
            }
        );
        ...
        fs.writeFileSync(
            "./born.del",
            `${id}\t${placeDict[placeKey]}\t${birthDate}\n`,
            {
                flag: "a+",
            }
        );
    ...
    for (let nobel of laureate.nobelPrizes) {
        ...
        if (nobel.affiliations) {
            for (let affiliation of nobel.affiliations) {
                ...
                let affCountry = affiliation.country
